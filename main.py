...
def attack(char_name: str, char_class: str) -> str:
    """Функция которая генерирует урон в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция которая генерирует блокирование в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция которая генерирует умения в зависимости от класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция которая проводит тренировку."""
    if char_class == 'warrior':
